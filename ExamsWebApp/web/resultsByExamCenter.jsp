<%-- 
    Document   : resultsByExamCenter
    Created on : Sep 25, 2018, 10:45:56 AM
    Author     : Maria
--%>
...
<html>
    ...
    <center>
        ...
        ID: <%= results.getEc_id()%>, Name: <%= results.getName()%>, Address: <%= results.getAddress()%><br>
        <br>
        </div>
        <%
            ArrayList<ExamResults> exRes = results.getExamResults();
